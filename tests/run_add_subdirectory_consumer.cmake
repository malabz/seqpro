if(NOT DEFINED SEQPRO_SOURCE_DIR OR NOT DEFINED SEQPRO_TEST_ROOT)
  message(FATAL_ERROR "SeqPro consumer test paths are required")
endif()

file(REMOVE_RECURSE "${SEQPRO_TEST_ROOT}")
file(MAKE_DIRECTORY "${SEQPRO_TEST_ROOT}/source")
configure_file(
  "${SEQPRO_SOURCE_DIR}/tests/consumer/add_subdirectory.CMakeLists.txt"
...
if(NOT build_result EQUAL 0)
  message(FATAL_ERROR "add_subdirectory consumer build failed:\n${build_output}\n${build_error}")
endif()
...
foreach(consumer_executable IN ITEMS seqpro-consumer seqpro-consumer-cxx20)
  ...
  if(NOT run_result EQUAL 0)
    message(FATAL_ERROR
      "add_subdirectory consumer '${consumer_executable}' failed:\n"
      "${run_output}\n${run_error}")
  endif()
endforeach()
